...
const Template1: React.FC<{ data: any; className: string }> = ({
  data,
  className,
}) => {
  let data1 = {
  ...
  return (
    <div
      className={`w-[350px] h-[200px] bg-slate-200 rounded-xl m-2 p-3 ${className} relative overflow-hidden`}
    >
      <div className="absolute z-0 top-0 left-0">
        {/* <Svg1 fillColor={"#fcff4d"} /> */}
      </div>
