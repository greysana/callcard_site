...
const Template3: React.FC<{ data: any; className: string }> = ({
  data,
  className,
})  => {
  let data1 = {
  ...
  return (
    <div className={`w-[350px] h-[200px] bg-slate-200 rounded-xl m-2 p-3 ${className}`}>
      <div className="grid grid-cols-2 gap-1 px-2">
        <div className=" p-3 py-1 flex flex-row justify-start items-start  ">
        ...
        <div className="p-3 py-2 flex flex-col items-end justify-end">
          <h1 className="text-[1rem] font-[600]">{data1.full_name}</h1>
