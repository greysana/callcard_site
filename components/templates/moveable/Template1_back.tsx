...
import Temp1_1_back from "@/components/svg_designs/back/Temp1_1_back";

const Template1_moveable_back: React.FC<{
  ...
  return (
    ...
    >
      <div className="absolute z-0 bottom-0 left-3 scale-x-[120%] scale-y-[150%] ">
        <Temp1_1_back fillColor={colors?.palette3} opacity={"1"} />
      </div>
...
export default Template1_moveable_back;
