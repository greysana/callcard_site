...
import Temp4_1_back from "@/components/svg_designs/back/Temp4_1_back";
import Temp4_2_back from "@/components/svg_designs/back/Temp4_2_back";
import Temp4_3_back from "@/components/svg_designs/back/Temp4_3_back";
import Temp4_4_back from "@/components/svg_designs/back/Temp4_4_back";
import Temp4_5_back from "@/components/svg_designs/back/Temp4_5_back";
...
const Template4_moveable_back: React.FC<{
  ...
  return (
    ...
    >
      <div className="absolute z-0 bottom-0 left-0 ">
        <Temp4_2_back fillColor={colors?.palette3} opacity={"0.2"} />
      </div>
      <div className="absolute z-0 top-3 -left-1 ">
        <Temp4_1_back fillColor={colors?.palette3} opacity={"1"} />
      </div>
      <div className="absolute z-0 top-0 left-0 ">
        <Temp4_3_back fillColor={colors?.palette3} opacity={"1"} />
      </div>{" "}
      <div className="absolute z-0 top-0 right-0 ">
        <Temp4_4_back fillColor={colors?.palette3} opacity={"0.2"} />
      </div>{" "}
      <div className="absolute z-0 top-0 -right-1 ">
        <Temp4_5_back fillColor={colors?.palette3} opacity={"0.2"} />
      </div>
...
export default Template4_moveable_back;
