...
import Temp5_1 from "@/components/svg_designs/Temp5_1";
import Temp5_2 from "@/components/svg_designs/Temp5_2";
...
const Template5_moveable: React.FC<{
  ...
  return (
    ...
    >
      <div className="absolute z-0 bottom-10 right-0 scale-y-150 scale-x-125">
        <Temp5_1
          fillColor={colors?.palette2}
          fillColor2={colors?.palette1}
          opacity={"1"}
        />
      </div>
      <div className="absolute z-0 bottom-10 right-0 scale-y-150">
        <Temp5_2
          fillColor={colors?.palette3}
          fillColor2={colors?.palette1}
          opacity={"1"}
        />
      </div>
      <div className="grid grid-cols-2 gap-1 px-2 relative z-99">
        {/* Company Logo */}
        <div className="p-3 py-1  cursor-pointer flex justify-center items-end">
          <img
            onClick={() => {
        ...
        <div className="p-3 py-2 flex flex-col items-end justify-end">
          <h1
            ...
            className="text-[1rem] font-[700] text-[clamp(1rem, 2vw, 1.5rem)] overflow-hidden text-ellipsis whitespace-nowrap"
          >
            {data.full_name}
          </h1>
          {selectedTarget === "name" && (
        ...
        <div className="p-1 flex flex-col justify-center items-center">
          ...
          <div className="p-1 cursor-pointer flex justify-end">
            <div
              ...
              // src={data?.qr_code}\
              className="  bg-white flex justify-center items-center p-1 relative bottom-3"
...
export default Template5_moveable;
