...
import Temp5_1_back from "@/components/svg_designs/back/Temp5_1_back";
import Temp5_2_back from "@/components/svg_designs/back/Temp5_2_back";
...
const Template5_moveable_back: React.FC<{
  ...
  return (
    ...
    >
      <div className="absolute z-0 top-3 left-0 scale-y-100 ">
        <Temp5_1_back fillColor={colors?.palette3} opacity={"1"} />
      </div>
      <div className="absolute z-0 top-3 right-0 scale-y-100 ">
        <Temp5_2_back fillColor={colors?.palette3} opacity={"1"} />
      </div>
      <div className="grid grid-cols-1 gap-1 px-2 relative z-99 justify-center items-center h-[100%]">
        {/* Company Logo */}
        <div className="p-3 py-1 cursor-pointer flex flex-col justify-end items-center">
          <img
            onClick={() => {
          ...
          <h6
            ...
            className="text-[.6rem] uppercase font-[400] pl-1"
            style={
...
export default Template5_moveable_back;
